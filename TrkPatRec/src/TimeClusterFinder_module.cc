  ...
  {  
    public:
        ...
        struct Config
        {
            ...
            fhicl::Atom<bool>                       recover                {Name("RecoverHits"),            Comment("Apply hit refining algorithm") }; 
            fhicl::Atom<bool>                       refine                 {Name("RefineClusters"),         Comment("Apply hit pre-filtering algorithm") }; 
            fhicl::Atom<bool>                       preFilter              {Name("PrefilterCluster"),       Comment("Apply hit recovery algorithm") }; 
